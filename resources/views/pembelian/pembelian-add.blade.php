...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Data /</span> Buat Barang Masuk
    </h4>
    <!-- Responsive Table -->
    <div class="card">
        <h5 class="card-header">Barang Masuk</h5>
        <div class="card-body">
            <form action="{{ route('barang-masuk-proses') }}" method="POST">
                @csrf
                <div class="row g-2">
                    <div class="col mb-3">
                        <label for="nameBasic" class="form-label">Tanggal Masuk</label>
                    ...
                    <div class="col mb-3" style="border: 1">
                        <label for="nameBasic" class="form-label">Nama Supplier</label>
                        <select class="supplier form-select" id="nama_supplier" style="padding: 12px 20px;width: 100%"
...
$(document).ready(function(){
        $('.supplier').select2({
            placeholder: 'Pilih Satuan', // Pesan placeholder untuk input select
            allowClear: true, // Menampilkan tombol "Hapus" untuk membersihkan seleksi
        });
