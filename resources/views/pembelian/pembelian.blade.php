...
<div class="container-xxl flex-grow-1 container-p-y">
    <h4 class="fw-bold py-3 mb-4">
        <span class="text-muted fw-light">Barang Masuk /</span> Daftar Barang Masuk
    </h4>
    <!-- Responsive Table -->
    <div class="card">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="text-center">
                            <div>
                                <a href="{{ route('barang-masuk-view', $item->id) }}" class="btn rounded-pill btn-icon btn-success" aria-label="view" data-bs-toggle="tooltip" data-bs-original-title="Lihat">
                                    <i class="bx bx-show-alt mx-1"></i>
                                </a>
                                {{-- <a href="{{ route('pembelian-delete', $item->id) }}" class="text-body"
                                    data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
                                    <i class="bx bx-trash mx-1"></i>
                                </a> --}}
                                <a href="{{ route('barang-masuk-delete', $item->id) }}" class="btn rounded-pill btn-icon btn-danger" data-bs-toggle="tooltip" aria-label="Delete" data-bs-original-title="Delete">
                                    <i class="bx bx-trash mx-1"></i>
                                  </a>
                            </div>
                        </td>
